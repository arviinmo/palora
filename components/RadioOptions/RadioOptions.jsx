...
function RadioOptions() {
  return (
    <div className="font-Poppins md:ml-5 bg-cyan-400 w-max text-xl sm:ml-2">
        <div className="flex items-center mb-1 mt-5">
            ...
            <label htmlFor="default-checkbox" className="xs:text-base ml-2 sl:text-xl font-medium text-gray-900 dark:text-gray-300">Include Symbols</label>
        </div>
        <div className="flex items-center mb-1">
            ...
            <label htmlFor="default-checkbox" className="xs:text-base ml-2 sl:text-xl font-medium text-gray-900 dark:text-gray-300">Include Numbers</label>
        </div>
        <div className="flex items-center mb-1">
            ...
            <label htmlFor="default-checkbox" className="xs:text-base ml-2 sl:text-xl font-medium text-gray-900 dark:text-gray-300">Include Uppercase Characters</label>
        </div>
        <div className="flex items-center mb-1">
            ...
            <label htmlFor="default-checkbox" className="xs:text-base ml-2 sl:text-xl font-medium text-gray-900 dark:text-gray-300">Include Lowercase Characters</label>
        </div>
    </div>
  )
}
