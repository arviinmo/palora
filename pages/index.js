...
export default function Home() {
  return (
    <div className="h-full">
      ...
      <div className="w-full flex place-items-center flex-col items-center justify-center h-full content-center ma:mt-[10rem] xs:mt-[5rem]">
        ...
        <footer className="font-Poppins lg:mt-[14rem] ma:mt-[8rem] xs:mt-[5rem] xs:text-sm sl:text-lg flex flex-wrap items-center">
          Proudly made in
          <Link href="#">
